...
- `Framework.VehicleKeysScript`: Set the vehicle keys script (e.g., 'qbcore', 'qbx-core', 't1ger', 'qs-vehiclekeys', 'wasabi', '0r-vehiclekeys', 'mrnewbvehiclekeys', 'other').
...
- Vehicle keys scripts (qbcore, qbx-core, t1ger, qs-vehiclekeys, wasabi, 0r-vehiclekeys, mrnewbvehiclekeys, other)
